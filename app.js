...
var x = 11;
for (var i = 0; i < 4; i++) {
  var response6 = prompt('How many miles in the sky is the stratosphere?').toLowerCase();
  if (response6 < x) {
  ...
  //   } else...
//Start the for /while loop for the 7th question with 6 tries

// //Start the final tally of number of correct questions
// for (var i = 0; i < numberOfQuestions; i++) {
//   var answer = prompt(questions[i]);
//   if (answer === correctAns[i]) {
//     alert(response[i][0] + userName + response[i][1]);
